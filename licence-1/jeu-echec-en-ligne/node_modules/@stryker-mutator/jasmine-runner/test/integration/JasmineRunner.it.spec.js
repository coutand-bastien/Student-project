...
var JasmineTestFramework_1 = require("@stryker-mutator/jasmine-framework/src/JasmineTestFramework");
var assertions_1 = require("../helpers/assertions");
var test_helpers_1 = require("@stryker-mutator/test-helpers");
...
describe('JasmineRunner integration', function () {
    ...
    describe('using the jasmine-init project', function () {
        ...
        beforeEach(function () {
            ...
            ], test_helpers_1.factory.strykerOptions({ jasmineConfigFile: 'spec/support/jasmine.json' }));
        });
    ...
    describe('using a jasmine-project with errors', function () {
        beforeEach(function () {
            ...
            sut = new JasmineTestRunner_1.default([path.resolve('lib', 'error.js'), path.resolve('spec', 'errorSpec.js')], test_helpers_1.factory.strykerOptions());
        });
    ...
    describe('when it includes failed tests', function () {
        beforeEach(function () {
            ...
            ], test_helpers_1.factory.strykerOptions());
        });
...
//# sourceMappingURL=JasmineRunner.it.spec.js.map