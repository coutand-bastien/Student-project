...
export default class TranspilingLanguageService {
    ...
    constructor(compilerOptions: Readonly<ts.CompilerOptions>, rootFiles: ReadonlyArray<File>, projectDirectory: string, produceSourceMaps: boolean, getLogger: LoggerFactoryMethod);
    /**
