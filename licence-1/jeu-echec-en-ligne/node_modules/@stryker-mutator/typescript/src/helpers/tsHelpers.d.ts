...
export declare function getTSConfig(options: StrykerOptions): ts.ParsedCommandLine | undefined;
export declare function getProjectDirectory(options: StrykerOptions): string;
/**
