...
export function top(pos : Position) : Position {
    let topPosition : Position = {file: pos.file, rank: pos.rank - 1};
    return topPosition;
}

export function bottom(pos : Position) : Position {
    let botPosition : Position = {file: pos.file, rank: pos.rank + 1};
    return botPosition;
}

export function left(pos : Position) : Position {
    let leftPosition : Position = {file: pos.file - 1, rank: pos.rank};
    return leftPosition;
}

export function right(pos : Position) : Position {
    let rightPosition : Position = {file: pos.file + 1, rank: pos.rank};
